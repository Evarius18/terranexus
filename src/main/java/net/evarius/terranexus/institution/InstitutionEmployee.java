...
public record InstitutionEmployee(String playerUuid, String role, long joinedAt, long salary,
                                  String salaryGroup, long nextPayAt, String personnelNote) {
    public static final Codec<InstitutionEmployee> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.STRING.optionalFieldOf("salary_group", "Individuell").forGetter(InstitutionEmployee::salaryGroup),
    ...
    public InstitutionEmployee withRole(InstitutionRole value) {
        return new InstitutionEmployee(playerUuid, value.id(), joinedAt, salary, salaryGroup, nextPayAt, personnelNote);
    }
    public InstitutionEmployee withSalary(long value) {
        return new InstitutionEmployee(playerUuid, role, joinedAt, value, "Individuell", nextPayAt, personnelNote);
    }
    public InstitutionEmployee withSalaryGroup(String group, long value) {
        return new InstitutionEmployee(playerUuid, role, joinedAt, value, group, nextPayAt, personnelNote);
    }
    public InstitutionEmployee withNextPayAt(long value) {
        return new InstitutionEmployee(playerUuid, role, joinedAt, salary, salaryGroup, value, personnelNote);
    }
    public InstitutionEmployee withPersonnelNote(String value) {
        return new InstitutionEmployee(playerUuid, role, joinedAt, salary, salaryGroup, nextPayAt, value);
    }
}
