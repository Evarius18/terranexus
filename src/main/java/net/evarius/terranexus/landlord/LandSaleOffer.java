...
public record LandSaleOffer(String propertyId, String sellerAccount, long price, long createdAt, String approvedBy) {
    public static final Codec<LandSaleOffer> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.STRING.optionalFieldOf("approved_by", "").forGetter(LandSaleOffer::approvedBy)
