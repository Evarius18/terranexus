...
public record ResidentialBuilding(String id, String name, String propertyId, String createdBy, long createdAt) {
    public static final Codec<ResidentialBuilding> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.STRING.optionalFieldOf("property_id", "").forGetter(ResidentialBuilding::propertyId),
    ...
    public ResidentialBuilding(String id, String name, String createdBy, long createdAt) {
        this(id, name, "", createdBy, createdAt);
    }
}
