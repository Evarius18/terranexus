...
public record OpenGuiPayload(String sessionToken, Text title, List<GuiMenuElement> elements) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, OpenGuiPayload> CODEC = PacketCodec.tuple(
            ...
            TextCodecs.REGISTRY_PACKET_CODEC, OpenGuiPayload::title,
